...
- **Backend**: Render  
  https://jobapplicationtracker-klmi.onrender.com
...
3. Create `.env` file inside `server/`:
   ...
   ```
   MONGO_URI=mongodb+srv://jobtracker:yourpassword@cluster0.bsbr3cc.mongodb.net/jobtracker?retryWrites=true&w=majority&appName=cluster_name
...
3. Create `.env` file inside `client/`:
   ...
   ```
   REACT_APP_API_URL=https://jobapplicationtracker-klmi.onrender.com
   ```
...
4. Add environment variable:
   ...
   ```
   REACT_APP_API_URL=https://jobapplicationtracker-klmi.onrender.com(add your backend url)
   ```
...
📌 Link: _[[video link](https://youtu.be/8nDWnuZmRXc)]_
